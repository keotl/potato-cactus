module PotatoCactus.Network.Packets.Out.UpdatePlayerPlacementReferencePacket where
...
import PotatoCactus.Game.Position (GetPosition (getPosition), Position (x), localX, localY, chunkY, chunkX, localToRefY, localToRefX)
...
updatePlayerPlacementReferencePacket :: Player -> Position -> ByteString
updatePlayerPlacementReferencePacket player placement =
  fixedPacket2
    85
    ( do
